...
@section('page-title', 'Sales Returns Management')
    ...
    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 flex flex-wrap items-center justify-between gap-3">
        <div>
            <span class="text-sm font-medium text-gray-700">
                <i class="fas fa-undo-alt text-gray-400 mr-2"></i> All Sales Returns
            </span>
            ...
            <table class="w-full" id="returnsTable">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        ...
                        <td class="py-3 px-2">
                            <a href="{{ route('admin.sales.show', $return->sale) }}" class="text-blue-600 hover:underline text-sm">
                                {{ $return->sale->invoice_no ?? 'N/A' }}
                            </a>
                        </td>
                        <td class="py-3 px-2">
                            <span class="font-medium text-gray-900">{{ $return->customer->name ?? 'N/A' }}</span>
                        </td>
                        ...
                        <td class="py-3 px-2 text-center">
                            <div class="flex items-center justify-center space-x-1">
                                ...
                                <form action="{{ route('admin.sales-returns.destroy', $return) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
