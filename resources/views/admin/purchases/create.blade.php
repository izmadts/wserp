                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mt-3 sm:mt-4">
                    <div>
                        <label for="status" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
                            ...
                            <x-help-tooltip>Draft and Ordered don't touch stock or the ledger yet - use them while the purchase is still being planned or awaited. Received posts the stock in and records the payable as unpaid (add a payment afterwards to settle it). Paid does the same but also records the full amount as settled immediately.</x-help-tooltip>
                        </label>
                        ...
                        <table class="w-full min-w-[700px]">
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td class="py-1.5 px-1.5">
                                        <input type="number" name="shipping_cost" x-model="shipping" @input="calculateTotals()"
                                            class="w-full px-1 py-1 text-sm text-right border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                            min="0" step="0.01">
                                    </td>
...
<script>
    function purchaseForm() {
        return {
            ...
            // recorded purchase price - catches fat-finger entry (e.g. an
            // extra digit) without blocking genuinely higher supplier quotes.
            overCost(item) {
