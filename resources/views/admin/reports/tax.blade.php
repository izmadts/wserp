...
@section('content')
<div class="space-y-6">
    @include('admin.partials.export-buttons', ['type' => 'tax'])
    <!-- Filter -->
    <div class="bg-white rounded-xl shadow-card p-4">
        <form method="GET" class="flex flex-wrap items-end gap-4">
            ...
            <div>
                <a href="{{ route('admin.reports.tax') }}" class="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg font-medium hover:bg-gray-300">
