...
@section('content')
<div class="space-y-6">
    @include('admin.partials.export-buttons', ['type' => 'trial-balance'])
    <!-- Date Filter -->
    <div class="bg-white rounded-xl shadow-card p-4 sm:p-6">
        <form method="GET" class="flex flex-wrap items-end gap-4">
            ...
            <div>
                <a href="{{ route('admin.reports.trial-balance') }}" class="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg font-medium hover:bg-gray-300 transition-colors duration-200">
