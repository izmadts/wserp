<x-khata-pdf-layout title="Customer Ledger Statement">
    <x-slot:meta>
        <div class="khata-meta">
            <strong>Customer:</strong> {{ $customer->name }} ({{ $customer->code }})
            @if($customer->phone) &nbsp;|&nbsp; <strong>Phone:</strong> {{ $customer->phone }} @endif
            @if($customer->city) &nbsp;|&nbsp; <strong>City:</strong> {{ $customer->city }} @endif
            <br>
