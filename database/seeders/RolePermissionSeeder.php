...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $defaults = [
            'manager' => [
                'full' => ['dashboard', 'products', 'categories', 'suppliers', 'purchases', 'purchase-returns', 'inventory', 'customers', 'sales', 'sales-returns', 'agents', 'approvals', 'reports', 'exports', 'employees', 'leaves'],
            ...
            'accountant' => [
                'full' => ['accounts', 'expenses', 'incomes', 'money-transfers', 'bank-reconciliations', 'reports', 'exports', 'payroll', 'approvals'],
